# VL-BERT
**Note: This repository is a copy from the official VL-Bert github found [here](https://github.com/jackroos/VL-BERT). This repository allows VL-Bert to run on Talk2Car. For this please read `t2c_readme.md`** 
