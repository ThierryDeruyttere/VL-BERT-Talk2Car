...
class REFER:
    ...
    def __init__(self, data_root, dataset='talk2car', split=None):
        # provide data_root folder which contains refclef, talk2car, talk2car+ and talk2carg
        # also provide dataset name and splitBy information
        # e.g., dataset = 'talk2car', splitBy = 'unc'
        ...
        ref_file = osp.join(self.DATA_DIR, 'annotations', 'ref_{}.json'.format(split))
        self.data = {}
        ...
        instances_file = osp.join(self.DATA_DIR, 'annotations', 'annotations_{}.json'.format(split))
        ...
        if len(image_ids) == len(cat_ids) == len(ref_ids) == len(split) == 0:
            ...
            if not len(split) == 0:
                if split in ['testA', 'testB', 'testC']:
                    ...
                    refs = [ref for ref in refs if "c4av" in ref['split']]
...
#     refer = REFER(dataset='talk2carg', splitBy='google')
