...
import os
import argparse
os.environ['TORCH_HOME'] = 'downloaded_models'

import torch
import subprocess

from talk2car.function.config import config, update_config
from talk2car.function.train import train_net
from talk2car.function.test import test_net
...
def main():
    ...
    config.NETWORK.NUMBER_OF_PROPOSALS = args.num_regions
